...
echo "== 3/6 Gravando versão melhorada de migrate-sqlite-to-postgres.js no host =="
...
JSEOF
echo "✅ Script de migração atualizado gravado em cora-api/scripts/migrate-sqlite-to-postgres.js"
echo ""
